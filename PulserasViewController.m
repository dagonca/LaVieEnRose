...
#import "PulserasViewController.h"
#import "CollectionViewCell.h"
#import "InfoViewController.h"
@interface PulserasViewController ()

@end

@implementation PulserasViewController
{
    NSArray *FotosArray;
    NSArray *FotosArray1;
    NSArray *FotosArray2;
...
- (void) retrieveFromParse {
    ...
    PFQuery *retrieveColors2 = [PFQuery queryWithClassName:@"Pulseras"];
...
- (IBAction)SegmentControl:(id)sender {
    ...
    if(segment.selectedSegmentIndex == 1){
        PFQuery *retrieveColors2 = [PFQuery queryWithClassName:@"Collares"];
